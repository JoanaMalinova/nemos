function Catalog() {
    return (
        <section id="arrivals" class="newest-arrivals store-main">
            <ul class="inner-arrivals inner-store">
                <li>
                    <article class="card">
